...
from lcacollect_config import email


@pytest.mark.asyncio
async def test_send_email_no_kwargs(mocker):
    mail_mock = mocker.patch("lcacollect_config.email.Mail", return_value="mail_obj")
    sendgrid_mock = mocker.patch("lcacollect_config.email.SendGridAPIClient")
