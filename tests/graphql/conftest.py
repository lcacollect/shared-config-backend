...
def entry_data():
    ...
    yield [
        ("Test 0", "70e94ba8-128c-4890-8291-b4982c0fb5f2"),
        ("Test 1", "36485ccc-d395-4a96-8ff9-e6dd713c734e"),
        ("Test 2", "5d02171c-483d-4c27-9cbb-20e9b7c6f802"),
    ]
...
def entries(db_engine, entry_model, init_db, entry_data):
    with Session(db_engine) as session:
        entries = [entry_model(id=_id, name=name) for name, _id in entry_data]
